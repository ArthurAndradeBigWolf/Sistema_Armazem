...
public class JanelaRemove extends JFrame implements ActionListener{
    ...
    public JanelaRemove(Armazem sistema){
    ...
    public void actionPerformed(ActionEvent e){
      ...
      if(e.getSource() == botao1){
        int procura;
        procura = Integer.parseInt(JOptionPane.showInputDialog(null,"CODIGO DA GELADEIRA:", "REMOVER", JOptionPane.PLAIN_MESSAGE));
        sistema.removeEstoque(gel,procura);
        JOptionPane.showMessageDialog(null," GELADEIRA REMOVIDA COM SUCESSO!!");
        setVisible(false);
      ...
      //FOGÃO
        ...
        sistema.removeEstoque(fog,procura);
        JOptionPane.showMessageDialog(null," FOGAO REMOVIDA COM SUCESSO!!");
        setVisible(false);
